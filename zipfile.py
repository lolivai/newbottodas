...
from pyobigram.readers import MonitorReader
...
class MultiFile(object):
    def __init__(self, file_name, max_file_size,dest_path='',total=0,monitor_callback=None,ext=''):
        self.current_position = 0
        self.ext = ext
        self.file_name = dest_path + file_name + '.7z'
        ...
        self.total = total
        self.index = 0
        self.monitor = MonitorReader(total)
    ...
    def open_next_file(self):
            file_name = self.dest_path + "%s.%03d" % (self.file_name, self.current_file_no + 1) + self.ext
